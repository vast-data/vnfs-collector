...
KEYSTORE_SIGN_REQUEST_SRL="ca.srl"
...
trust_store_private_key_file=""
  ...
  openssl req -new -x509 -keyout $TRUSTSTORE_WORKING_DIRECTORY/ca.key \
    -out $TRUSTSTORE_WORKING_DIRECTORY/ca.crt -days $VALIDITY_IN_DAYS -nodes \
  ...
  echo " - $TRUSTSTORE_WORKING_DIRECTORY/ca.crt -- the certificate that will be"
  ...
  keytool -keystore $TRUSTSTORE_WORKING_DIRECTORY/$DEFAULT_TRUSTSTORE_FILENAME \
    -alias CARoot -import -file $TRUSTSTORE_WORKING_DIRECTORY/ca.crt \
