    ...
    def attach(self):
        ...
        if BPF.get_kprobe_functions(b'nfs_file_mmap_prepare'):
            self.b.attach_kprobe(event="nfs_file_mmap_prepare",
                                 fn_name="trace_nfs_file_mmap")                                  # updates mmap count
            self.b.attach_kretprobe(event="nfs_file_mmap_prepare",
                                    fn_name="trace_nfs_file_mmap_ret")                           # updates mmap errors,duration
        elif BPF.get_kprobe_functions(b'nfs_file_mmap'):
